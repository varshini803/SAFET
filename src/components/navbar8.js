        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link3Url} target="_blank" rel="noreferrer noopener">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text18 thq-body-small thq-link">
                    /emergency-contacts
                  </span>
                </Fragment>
              )}
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text24">Main Action</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Secondary Action</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span>
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text22 thq-body-large">
                                  Safety Tips
                                </span>
                              </Fragment>
                            )}
...
Navbar8.defaultProps = {
  action2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1590650265179-7e13941e93f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDg3MDQ3Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1506704810770-7e9bbab1094b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDg3MDQ3Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  page4: undefined,
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1533091917107-98f819e4cb54?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDg3MDQ3NXw&ixlib=rb-4.0.3&q=80&w=1080',
  link2: undefined,
  page3: undefined,
  link3: undefined,
  ...
  logoAlt: "Women's Safety Logo",
  page2ImageSrc:
    'https://images.unsplash.com/photo-1616769186373-bc4943852aeb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDg3MDQ3Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  link4: undefined,
  page2: undefined,
  page1: undefined,
